...
var Carousel = React.createClass({ displayName: "Carousel",
  ...
  render: function () {
    ...
    var swipeContainerChildren = this.props.children.map(function (item, i) {
      return React.createElement("div", { key: i, style: { float: 'left' } }, item);
    });

    var swipeContainer = React.createElement(Swipeable, { onSwipingRight: this.prevImageScroll,
      ...
      } }, swipeContainerChildren, clear);

    return React.createElement("div", React.__spread({}, this.props, { style: { overflow: 'hidden', width: '100%' } }), swipeContainer);
  }
});
